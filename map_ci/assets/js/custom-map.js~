...
var availableStores = [];
var availableClass = [];
var base_url = 'http://www.bitgazetteer.com/';
var no_logo_atm;
var no_logo_store;
var no_logo_class;
var no_logo_offer;
...
i++;
        ...
        var icon = "/map_ci/assets/img/atm.png";
...
i++;
      ...
      var coin ='';
       ...
       for(var yx=0;yx<StoresCat_length;yx++) {
        ...
        var icon = "/map_ci/assets/img/store.png";
        var latlng = new google.maps.LatLng(lat, lon);     
        var marker = new google.maps.Marker({
            map: map,
            zoom: 10,
...
i++;
       var coin = null;
        ...
        var icon = "/map_ci/assets/img/offers.png";
        var latlng = new google.maps.LatLng(lat, lon);    
        var marker = new google.maps.Marker({
            map: map,
            zoom: 10,
...
i++;
      ...
      var coin ='';
       ...
       var storeCat = category_sub_category.data.search.classifield_sub_category
        ...
        var icon = "/map_ci/assets/img/class.png";
        var latlng = new google.maps.LatLng(lat, lon);   
        var marker = new google.maps.Marker({
            map: map,
            zoom: 10,
...
document.getElementById('fbShareBtn').onclick = function() {
    FB.ui({
        ...
        picture: 'http://www.coinmapia.com/map_ci/assets/img/cover_image.png',
